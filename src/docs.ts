...
firestore-cli --service-account ./prod-key.json export -o ./backups

# Import to staging
firestore-cli --service-account ./staging-key.json import ./backups/firestore_export.json
\`\`\`
...
firestore-cli export -o "./backups/backup_$DATE"
\`\`\`

### Data Migration
\`\`\`bash
# Export from old project
firestore-cli --project old-project export -o ./migration

# Import to new project
firestore-cli --project new-project import ./migration/firestore_export.json
\`\`\`
...
5. **"Token expired"**: Run \`firestore-cli login --force\`

### Debug Mode
Set environment variable for detailed logging:
\`\`\`bash
export DEBUG=firestore-cli:*
